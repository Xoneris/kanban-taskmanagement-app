...
<template>
    ...
    >
        ...
        <div @click.stop class="relative bg-white dark:bg-dark-grey w-full max-w-[480px] max-h-[90vh] sm:max-h-full flex flex-col gap-4 rounded-[6px] p-8 mx-4 overflow-y-auto">
